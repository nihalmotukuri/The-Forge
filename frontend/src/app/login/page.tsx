...
export default async function Login() {
  ...
  return (
    ...
    >
      <form
        className="w-[480px] bg-[#181818] flex flex-col justify-center items-center gap-4 px-8 py-10 rounded-xl border-b-4 border-[#e3ff04]"
        action=""
      >
        <div className="flex flex-col gap-4 w-full">
          <button className="border border-[#e3ff04] text-sm font-semibold px-5 py-4 rounded-xl flex justify-center items-center gap-2">
        ...
        <div className="flex flex-col w-full gap-4">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <Link
              href="/register"
              className="text-[#00f0ff] flex items-center underline"
            >
